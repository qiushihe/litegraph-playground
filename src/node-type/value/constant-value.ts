...
class ConstantValueNode extends BaseNode {
  static title = TITLE;
  ...
  constructor() {
    super(TITLE, {
      ...
      properties: [["value", nodeProperty("object", {})]],
      metadata: [["value", {}]]
    });
  ...
  onDrawForeground(ctx: CanvasRenderingContext2D) {
    ...
    let remainingText = JSON.stringify(this.getMeta<unknown>("value"));
  ...
  onExecute() {
    this.setOutputData(0, this.getMeta("value"));
  }
}
